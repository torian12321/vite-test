...
export const getSelectedField = createSelector([getSettings], (settings): string => settings.selectedField || '');
...
export const getDisplayMode = createSelector([getSettings], (settings): MODES => settings.mode);
